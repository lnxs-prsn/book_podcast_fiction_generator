...
DEFAULT_SYSTEM_PROMPT_GENERATE_CHAPTER = (
    ...
    "Your job is to write the next chapter only. The chapter MUST be between "
    "1500 and 2500 words — both limits are hard requirements. Write fully "
    "developed scenes with rich description, dialogue, and interiority. "
    "Stop and end the chapter cleanly once you reach 2500 words. "
    "Do not summarise or cut scenes short before 1500 words. Follow the style contract "
...
DEFAULT_SYSTEM_PROMPT_UPDATE_LIVING_DOC = (
    ...
    "state after this chapter. Increment touch counts for terms used. "
    "Move terms between sections as they earn higher status. "
    ...
    "CRITICAL: Your output MUST contain ALL of the following section headers, "
    "verbatim, in this exact order, with no additions or omissions: "
    "=== LIVING DOCUMENT === | "
    "--- CURRENT STATE --- | "
    "--- ACTIVE VOCABULARY --- | "
    "--- TERMS LEARNED BUT NOT YET OWNED --- | "
    ...
    "--- NEXT CHAPTER TARGET --- | "
    "--- NOTES FOR AI --- "
    "(replace | with a newline in your output). "
    "Do NOT merge sections. Do NOT drop any header. "
    "The first line of your response MUST be: === LIVING DOCUMENT ==="
)
