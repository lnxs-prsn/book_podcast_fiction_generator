...
| anchor "manifestation" | `update_brief.json`, `assembler.md`, C3 | enum: `seen \| traces \| bystander_mention \| notebook_page \| none`; recorded on `observable_log` entries | `state/mystery_anchor.json` (`observable_log[].manifestation`) |
